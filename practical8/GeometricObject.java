package practical8GRADED;

import java.util.Date;

//Making Scalable interface
interface Scalable {
	public abstract void scale(double factor);
}

//Applying scalable interface to class
public abstract class GeometricObject implements Scalable, Comparable<GeometricObject> {
	...
	//Adding compare to method to the class
	@Override
